...
- Embedded libffi DLL for Windows ARM64 added.

### Changed

- Updated libffi binaries to version 3.8.0.

### Fixed

- Fixed potential crash caused by prematurely freed objects [#19](https://github.com/JupiterRider/ffi/issues/19).
...
[0.8.0]: https://github.com/JupiterRider/ffi/compare/v0.7.0...v0.8.0
